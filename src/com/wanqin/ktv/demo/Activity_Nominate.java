...
public class Activity_Nominate extends MyActivity implements OnClickListener {
	...
	class Adapter_ListView extends BaseAdapter{
		...
		public View getView(int position, View view, ViewGroup parent) {
			view=LayoutInflater.from(Activity_Nominate.this).inflate(R.layout.item_listview_nominate, null);
			return view;
		}
