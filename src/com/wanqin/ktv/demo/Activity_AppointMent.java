...
public class Activity_AppointMent extends MyActivity implements OnClickListener{
	...
	class Adapter_ListView extends BaseAdapter {
		...
		public View getView(int position, View view, ViewGroup parent) {
			view = LayoutInflater.from(Activity_AppointMent.this).inflate(
					R.layout.item_listview_appointment, null);
			return view;
		}
